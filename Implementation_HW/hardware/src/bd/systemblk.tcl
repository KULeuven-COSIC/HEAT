...
################################################################
# This is a generated script based on design: systemblk
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: fifo_high_to_low, and set properties
  set fifo_high_to_low [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 fifo_high_to_low ]
  set_property -dict [ list \
  ...
  # Create instance: fifo_low_to_high, and set properties
  set fifo_low_to_high [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 fifo_low_to_high ]
  set_property -dict [ list \
   CONFIG.FIFO_DEPTH {1024} \
   CONFIG.HAS_RD_DATA_COUNT {0} \
   CONFIG.HAS_WR_DATA_COUNT {0} \
  ...
  # Create instance: interconnect_to_dma, and set properties
  set interconnect_to_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 interconnect_to_dma ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $interconnect_to_dma

  # Create instance: interconnect_to_mem, and set properties
  set interconnect_to_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 interconnect_to_mem ]
  set_property -dict [ list \
   CONFIG.ENABLE_ADVANCED_OPTIONS {1} \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {2} \
  ...
  set interfacer_0 [ create_bd_cell -type ip -vlnv cosic:fturan:interfacer:1.0 interfacer_0 ]
  set_property -dict [ list \
   CONFIG.REG_ADDR_WIDTH {6} \
 ] $interfacer_0

  # Create instance: interfacer_1, and set properties
  set interfacer_1 [ create_bd_cell -type ip -vlnv cosic:fturan:interfacer:1.0 interfacer_1 ]

  # Create instance: mutex_0, and set properties
  set mutex_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:mutex:2.1 mutex_0 ]
  set_property -dict [ list \
   CONFIG.C_ENABLE_USER {0} \
   CONFIG.C_NUM_MUTEX {2} \
   CONFIG.C_S0_AXI_ACLK_FREQ_MHZ {150.0} \
   CONFIG.C_S1_AXI_ACLK_FREQ_MHZ {150.0} \
 ] $mutex_0
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {133.320007} \
  ...
  connect_bd_intf_net -intf_net S00_AXIS_1 [get_bd_intf_pins axis_interconnect_1/S00_AXIS] [get_bd_intf_pins interfacer_0/m00_axis]
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins interconnect_to_mem/S00_AXI]
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins interconnect_to_mem/S01_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins fifo_high_to_low/S_AXIS]
  connect_bd_intf_net -intf_net axis_interconnect_0_M00_AXIS [get_bd_intf_pins axis_interconnect_0/M00_AXIS] [get_bd_intf_pins interfacer_0/s00_axis]
  connect_bd_intf_net -intf_net axis_interconnect_0_M01_AXIS [get_bd_intf_pins axis_interconnect_0/M01_AXIS] [get_bd_intf_pins interfacer_1/s00_axis]
  connect_bd_intf_net -intf_net axis_interconnect_1_M00_AXIS [get_bd_intf_pins axis_interconnect_1/M00_AXIS] [get_bd_intf_pins fifo_low_to_high/S_AXIS]
  connect_bd_intf_net -intf_net fifo_high_to_low_M_AXIS [get_bd_intf_pins axis_interconnect_0/S00_AXIS] [get_bd_intf_pins fifo_high_to_low/M_AXIS]
  connect_bd_intf_net -intf_net fifo_low_to_high_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins fifo_low_to_high/M_AXIS]
  connect_bd_intf_net -intf_net interconnect_to_csr_M00_AXI [get_bd_intf_pins interconnect_to_csr/M00_AXI] [get_bd_intf_pins interfacer_0/s00_axi]
  connect_bd_intf_net -intf_net interconnect_to_csr_M01_AXI [get_bd_intf_pins interconnect_to_csr/M01_AXI] [get_bd_intf_pins interfacer_1/s00_axi]
  connect_bd_intf_net -intf_net interconnect_to_csr_M02_AXI [get_bd_intf_pins axis_interconnect_1/S_AXI_CTRL] [get_bd_intf_pins interconnect_to_csr/M02_AXI]
  connect_bd_intf_net -intf_net interconnect_to_csr_M03_AXI [get_bd_intf_pins axis_interconnect_0/S_AXI_CTRL] [get_bd_intf_pins interconnect_to_csr/M03_AXI]
  connect_bd_intf_net -intf_net interconnect_to_csr_M04_AXI [get_bd_intf_pins interconnect_to_csr/M04_AXI] [get_bd_intf_pins mutex_0/S0_AXI]
  connect_bd_intf_net -intf_net interconnect_to_csr_M05_AXI [get_bd_intf_pins interconnect_to_csr/M05_AXI] [get_bd_intf_pins mutex_0/S1_AXI]
  connect_bd_intf_net -intf_net interconnect_to_dma_M00_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins interconnect_to_dma/M00_AXI]
  connect_bd_intf_net -intf_net interconnect_to_mem_M00_AXI [get_bd_intf_pins interconnect_to_mem/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  connect_bd_intf_net -intf_net interfacer_1_M00_AXIS [get_bd_intf_pins axis_interconnect_1/S01_AXIS] [get_bd_intf_pins interfacer_1/m00_axis]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins interconnect_to_csr/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  ...
  connect_bd_net -net Net [get_bd_pins PROCESSOR_POLY_0/ddr_address] [get_bd_pins PROCESSOR_POLY_0/ddr_din] [get_bd_pins PROCESSOR_POLY_0/ddr_interrupt] [get_bd_pins PROCESSOR_POLY_0/ddr_we] [get_bd_pins PROCESSOR_POLY_1/ddr_address] [get_bd_pins PROCESSOR_POLY_1/ddr_din] [get_bd_pins PROCESSOR_POLY_1/ddr_interrupt] [get_bd_pins PROCESSOR_POLY_1/ddr_we] [get_bd_pins xlconstant_1/dout]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xB0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs interfacer_0/s00_axi/axi_lite] SEG_interfacer_0_axi_lite
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs interfacer_1/s00_axi/axi_lite] SEG_interfacer_1_axi_lite
  create_bd_addr_seg -range 0x00001000 -offset 0xA0004000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mutex_0/S0_AXI/Reg] SEG_mutex_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0005000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mutex_0/S1_AXI/S1_AXI_Reg] SEG_mutex_0_S1_AXI_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0003000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_interconnect_0/xbar/S_AXI_CTRL/Reg] SEG_xbar_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0002000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_interconnect_1/xbar/S_AXI_CTRL/Reg] SEG_xbar_Reg4
