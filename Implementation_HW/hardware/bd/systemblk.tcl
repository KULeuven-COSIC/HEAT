...
proc create_root_design { parentCell } {
  ...
  # Create instance: csr_ip_0, and set properties
  set csr_ip_0 [ create_bd_cell -type ip -vlnv user.org:user:csr_ip:1.0 csr_ip_0 ]
  set_property -dict [ list \
  ...
  set fifo_high_to_low [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:1.1 fifo_high_to_low ]
  set_property -dict [ list \
   CONFIG.IS_ACLK_ASYNC {1} \
 ] $fifo_high_to_low

  # Create instance: fifo_low_to_high, and set properties
  set fifo_low_to_high [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:1.1 fifo_low_to_high ]
  set_property -dict [ list \
   CONFIG.IS_ACLK_ASYNC {1} \
 ] $fifo_low_to_high
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins csr_ip_0/S00_AXI] [get_bd_intf_pins interconnect_to_csr/M00_AXI]
  connect_bd_intf_net -intf_net eth_ip_0_M00_AXIS [get_bd_intf_pins eth_ip_0/M00_AXIS] [get_bd_intf_pins fifo_low_to_high/S_AXIS]
  connect_bd_intf_net -intf_net fifo_high_to_low_M_AXIS [get_bd_intf_pins eth_ip_0/S00_AXIS] [get_bd_intf_pins fifo_high_to_low/M_AXIS]
  ...
  connect_bd_net -net Net [get_bd_pins PROCESSOR_POLY_0/ddr_address] [get_bd_pins PROCESSOR_POLY_0/ddr_din] [get_bd_pins PROCESSOR_POLY_0/ddr_interrupt] [get_bd_pins PROCESSOR_POLY_0/ddr_we] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net PROCESSOR_POLY_0_done [get_bd_pins PROCESSOR_POLY_0/done] [get_bd_pins csr_ip_0/poly_done] [get_bd_pins xlconcat_0/In0]
  ...
  connect_bd_net -net csr_ip_0_eth_command [get_bd_pins csr_ip_0/eth_command] [get_bd_pins eth_ip_0/Command0]
  connect_bd_net -net csr_ip_0_instruction [get_bd_pins PROCESSOR_POLY_0/instruction] [get_bd_pins csr_ip_0/poly_instruction] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net csr_ip_0_modulus_sel [get_bd_pins PROCESSOR_POLY_0/modulus_sel] [get_bd_pins csr_ip_0/poly_modulus]
  connect_bd_net -net csr_ip_0_poly_rdM0 [get_bd_pins PROCESSOR_POLY_0/rdM0] [get_bd_pins csr_ip_0/poly_rdM0]
  connect_bd_net -net csr_ip_0_poly_rdM1 [get_bd_pins PROCESSOR_POLY_0/rdM1] [get_bd_pins csr_ip_0/poly_rdM1]
  connect_bd_net -net csr_ip_0_poly_wtM0 [get_bd_pins PROCESSOR_POLY_0/wtM0] [get_bd_pins csr_ip_0/poly_wtM0]
  connect_bd_net -net csr_ip_0_poly_wtM1 [get_bd_pins PROCESSOR_POLY_0/wtM1] [get_bd_pins csr_ip_0/poly_wtM1]
  ...
  connect_bd_net -net eth_ip_0_eth_to_proc_data [get_bd_pins PROCESSOR_POLY_0/dinb_eth] [get_bd_pins eth_ip_0/eth_to_proc_data]
  connect_bd_net -net eth_ip_0_eth_to_proc_we [get_bd_pins PROCESSOR_POLY_0/web_eth] [get_bd_pins eth_ip_0/eth_to_proc_we]
  connect_bd_net -net rst_ps8_0_299M_interconnect_aresetn [get_bd_pins fifo_high_to_low/s_axis_aresetn] [get_bd_pins fifo_low_to_high/m_axis_aresetn] [get_bd_pins interconnect_to_dma/ARESETN] [get_bd_pins interconnect_to_mem/ARESETN] [get_bd_pins rst_ps8_0_299M/interconnect_aresetn]
  ...
  connect_bd_net -net rst_ps8_0_99M_interconnect_aresetn [get_bd_pins fifo_high_to_low/m_axis_aresetn] [get_bd_pins fifo_low_to_high/s_axis_aresetn] [get_bd_pins interconnect_to_csr/ARESETN] [get_bd_pins rst_ps8_0_99M/interconnect_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins csr_ip_0/s00_axi_aresetn] [get_bd_pins eth_ip_0/m00_axis_aresetn] [get_bd_pins eth_ip_0/s00_axis_aresetn] [get_bd_pins interconnect_to_csr/M00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins csr_ip_0/status] [get_bd_pins xlconcat_0/dout]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins PROCESSOR_POLY_0/clk] [get_bd_pins csr_ip_0/s00_axi_aclk] [get_bd_pins eth_ip_0/m00_axis_aclk] [get_bd_pins eth_ip_0/s00_axis_aclk] [get_bd_pins fifo_high_to_low/m_axis_aclk] [get_bd_pins fifo_low_to_high/s_axis_aclk] [get_bd_pins interconnect_to_csr/ACLK] [get_bd_pins interconnect_to_csr/M00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs csr_ip_0/S00_AXI/S00_AXI_reg] SEG_csr_ip_0_S00_AXI_reg
