...
# module references:
# homenc_coprocessor, homenc_coprocessor, homenc_coprocessor, homenc_coprocessor, homenc_coprocessor, homenc_coprocessor, interfacer, interfacer, interfacer, interfacer, interfacer, interfacer
...
proc create_root_design { parentCell } {
  ...
  # Create instance: homenc_coprocessor_4, and set properties
  set block_name homenc_coprocessor
  set block_cell_name homenc_coprocessor_4
  if { [catch {set homenc_coprocessor_4 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $homenc_coprocessor_4 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: homenc_coprocessor_5, and set properties
  set block_name homenc_coprocessor
  set block_cell_name homenc_coprocessor_5
  if { [catch {set homenc_coprocessor_5 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $homenc_coprocessor_5 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: interfacer_4, and set properties
  set block_name interfacer
  set block_cell_name interfacer_4
  if { [catch {set interfacer_4 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $interfacer_4 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: interfacer_5, and set properties
  set block_name interfacer
  set block_cell_name interfacer_5
  if { [catch {set interfacer_5 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $interfacer_5 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M04_AXI [get_bd_intf_pins axi_gpio_4/S_AXI] [get_bd_intf_pins axi_interconnect_1/M04_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_1_M05_AXI [get_bd_intf_pins axi_gpio_5/S_AXI] [get_bd_intf_pins axi_interconnect_1/M05_AXI]
  ...
  connect_bd_net -net axi_bram_ctrl_4_bram_addr_a [get_bd_pins axi_bram_ctrl_4/bram_addr_a] [get_bd_pins interfacer_4/bram_addr_a]
  connect_bd_net -net axi_bram_ctrl_4_bram_clk_a [get_bd_pins axi_bram_ctrl_4/bram_clk_a] [get_bd_pins interfacer_4/bram_clk_a]
  connect_bd_net -net axi_bram_ctrl_4_bram_en_a [get_bd_pins axi_bram_ctrl_4/bram_en_a] [get_bd_pins interfacer_4/bram_en_a]
  connect_bd_net -net axi_bram_ctrl_4_bram_rst_a [get_bd_pins axi_bram_ctrl_4/bram_rst_a] [get_bd_pins interfacer_4/bram_rst_a]
  connect_bd_net -net axi_bram_ctrl_4_bram_we_a [get_bd_pins axi_bram_ctrl_4/bram_we_a] [get_bd_pins interfacer_4/bram_we_a]
  connect_bd_net -net axi_bram_ctrl_4_bram_wrdata_a [get_bd_pins axi_bram_ctrl_4/bram_wrdata_a] [get_bd_pins interfacer_4/bram_wrdata_a]
  connect_bd_net -net axi_bram_ctrl_5_bram_addr_a [get_bd_pins axi_bram_ctrl_5/bram_addr_a] [get_bd_pins interfacer_5/bram_addr_a]
  connect_bd_net -net axi_bram_ctrl_5_bram_clk_a [get_bd_pins axi_bram_ctrl_5/bram_clk_a] [get_bd_pins interfacer_5/bram_clk_a]
  connect_bd_net -net axi_bram_ctrl_5_bram_en_a [get_bd_pins axi_bram_ctrl_5/bram_en_a] [get_bd_pins interfacer_5/bram_en_a]
  connect_bd_net -net axi_bram_ctrl_5_bram_rst_a [get_bd_pins axi_bram_ctrl_5/bram_rst_a] [get_bd_pins interfacer_5/bram_rst_a]
  connect_bd_net -net axi_bram_ctrl_5_bram_we_a [get_bd_pins axi_bram_ctrl_5/bram_we_a] [get_bd_pins interfacer_5/bram_we_a]
  connect_bd_net -net axi_bram_ctrl_5_bram_wrdata_a [get_bd_pins axi_bram_ctrl_5/bram_wrdata_a] [get_bd_pins interfacer_5/bram_wrdata_a]
  ...
  connect_bd_net -net axi_gpio_4_gpio2_io_o [get_bd_pins axi_gpio_4/gpio2_io_o] [get_bd_pins interfacer_4/io32_1_in]
  connect_bd_net -net axi_gpio_4_gpio_io_o [get_bd_pins axi_gpio_4/gpio_io_o] [get_bd_pins interfacer_4/io32_0_in]
  connect_bd_net -net axi_gpio_5_gpio2_io_o [get_bd_pins axi_gpio_5/gpio2_io_o] [get_bd_pins interfacer_5/io32_1_in]
  connect_bd_net -net axi_gpio_5_gpio_io_o [get_bd_pins axi_gpio_5/gpio_io_o] [get_bd_pins interfacer_5/io32_0_in]
  connect_bd_net -net f1_inst_clk_main_a0_out [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins f1_inst/clk_main_a0_out] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net f1_inst_clk_main_a0_out1 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_bram_ctrl_3/s_axi_aclk] [get_bd_pins axi_bram_ctrl_4/s_axi_aclk] [get_bd_pins axi_bram_ctrl_5/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_gpio_5/s_axi_aclk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/M03_ACLK] [get_bd_pins axi_interconnect_1/M04_ACLK] [get_bd_pins axi_interconnect_1/M05_ACLK] [get_bd_pins f1_inst/clk_extra_c1_out] [get_bd_pins homenc_coprocessor_0/clk] [get_bd_pins homenc_coprocessor_1/clk] [get_bd_pins homenc_coprocessor_2/clk] [get_bd_pins homenc_coprocessor_3/clk] [get_bd_pins homenc_coprocessor_4/clk] [get_bd_pins homenc_coprocessor_5/clk]
  ...
  connect_bd_net -net homenc_coprocessor_4_cpu_mem_rd_data [get_bd_pins homenc_coprocessor_4/cpu_mem_rd_data] [get_bd_pins interfacer_4/cpu_mem_rd_data]
  connect_bd_net -net homenc_coprocessor_4_done [get_bd_pins homenc_coprocessor_4/done] [get_bd_pins interfacer_4/done]
  connect_bd_net -net homenc_coprocessor_5_cpu_mem_rd_data [get_bd_pins homenc_coprocessor_5/cpu_mem_rd_data] [get_bd_pins interfacer_5/cpu_mem_rd_data]
  connect_bd_net -net homenc_coprocessor_5_done [get_bd_pins homenc_coprocessor_5/done] [get_bd_pins interfacer_5/done]
  ...
  connect_bd_net -net interfacer_4_bram_rddata_a [get_bd_pins axi_bram_ctrl_4/bram_rddata_a] [get_bd_pins interfacer_4/bram_rddata_a]
  connect_bd_net -net interfacer_4_cpu_interrupt [get_bd_pins homenc_coprocessor_4/cpu_interrupt] [get_bd_pins interfacer_4/cpu_interrupt]
  connect_bd_net -net interfacer_4_cpu_mb_all [get_bd_pins homenc_coprocessor_4/cpu_mb_all] [get_bd_pins interfacer_4/cpu_mb_all]
  connect_bd_net -net interfacer_4_cpu_mb_strobe [get_bd_pins homenc_coprocessor_4/cpu_mb_strobe] [get_bd_pins interfacer_4/cpu_mb_strobe]
  connect_bd_net -net interfacer_4_cpu_mem_addr [get_bd_pins homenc_coprocessor_4/cpu_mem_addr] [get_bd_pins interfacer_4/cpu_mem_addr]
  connect_bd_net -net interfacer_4_cpu_mem_sel [get_bd_pins homenc_coprocessor_4/cpu_mem_sel] [get_bd_pins interfacer_4/cpu_mem_sel]
  connect_bd_net -net interfacer_4_cpu_mem_wr_data [get_bd_pins homenc_coprocessor_4/cpu_mem_wr_data] [get_bd_pins interfacer_4/cpu_mem_wr_data]
  connect_bd_net -net interfacer_4_cpu_mem_wr_en [get_bd_pins homenc_coprocessor_4/cpu_mem_wr_en] [get_bd_pins interfacer_4/cpu_mem_wr_en]
  connect_bd_net -net interfacer_4_instruction [get_bd_pins homenc_coprocessor_4/instruction] [get_bd_pins interfacer_4/instruction]
  connect_bd_net -net interfacer_4_io32_0_out [get_bd_pins axi_gpio_4/gpio_io_i] [get_bd_pins interfacer_4/io32_0_out]
  connect_bd_net -net interfacer_4_io32_1_out [get_bd_pins axi_gpio_4/gpio2_io_i] [get_bd_pins interfacer_4/io32_1_out]
  connect_bd_net -net interfacer_4_modulus_sel [get_bd_pins homenc_coprocessor_4/modulus_sel] [get_bd_pins interfacer_4/modulus_sel]
  connect_bd_net -net interfacer_4_rdM0 [get_bd_pins homenc_coprocessor_4/rdM0] [get_bd_pins interfacer_4/rdM0]
  connect_bd_net -net interfacer_4_rdM1 [get_bd_pins homenc_coprocessor_4/rdM1] [get_bd_pins interfacer_4/rdM1]
  connect_bd_net -net interfacer_4_wtM0 [get_bd_pins homenc_coprocessor_4/wtM0] [get_bd_pins interfacer_4/wtM0]
  connect_bd_net -net interfacer_4_wtM1 [get_bd_pins homenc_coprocessor_4/wtM1] [get_bd_pins interfacer_4/wtM1]
  connect_bd_net -net interfacer_5_bram_rddata_a [get_bd_pins axi_bram_ctrl_5/bram_rddata_a] [get_bd_pins interfacer_5/bram_rddata_a]
  connect_bd_net -net interfacer_5_cpu_interrupt [get_bd_pins homenc_coprocessor_5/cpu_interrupt] [get_bd_pins interfacer_5/cpu_interrupt]
  connect_bd_net -net interfacer_5_cpu_mb_all [get_bd_pins homenc_coprocessor_5/cpu_mb_all] [get_bd_pins interfacer_5/cpu_mb_all]
  connect_bd_net -net interfacer_5_cpu_mb_strobe [get_bd_pins homenc_coprocessor_5/cpu_mb_strobe] [get_bd_pins interfacer_5/cpu_mb_strobe]
  connect_bd_net -net interfacer_5_cpu_mem_addr [get_bd_pins homenc_coprocessor_5/cpu_mem_addr] [get_bd_pins interfacer_5/cpu_mem_addr]
  connect_bd_net -net interfacer_5_cpu_mem_sel [get_bd_pins homenc_coprocessor_5/cpu_mem_sel] [get_bd_pins interfacer_5/cpu_mem_sel]
  connect_bd_net -net interfacer_5_cpu_mem_wr_data [get_bd_pins homenc_coprocessor_5/cpu_mem_wr_data] [get_bd_pins interfacer_5/cpu_mem_wr_data]
  connect_bd_net -net interfacer_5_cpu_mem_wr_en [get_bd_pins homenc_coprocessor_5/cpu_mem_wr_en] [get_bd_pins interfacer_5/cpu_mem_wr_en]
  connect_bd_net -net interfacer_5_instruction [get_bd_pins homenc_coprocessor_5/instruction] [get_bd_pins interfacer_5/instruction]
  connect_bd_net -net interfacer_5_io32_0_out [get_bd_pins axi_gpio_5/gpio_io_i] [get_bd_pins interfacer_5/io32_0_out]
  connect_bd_net -net interfacer_5_io32_1_out [get_bd_pins axi_gpio_5/gpio2_io_i] [get_bd_pins interfacer_5/io32_1_out]
  connect_bd_net -net interfacer_5_modulus_sel [get_bd_pins homenc_coprocessor_5/modulus_sel] [get_bd_pins interfacer_5/modulus_sel]
  connect_bd_net -net interfacer_5_rdM0 [get_bd_pins homenc_coprocessor_5/rdM0] [get_bd_pins interfacer_5/rdM0]
  connect_bd_net -net interfacer_5_rdM1 [get_bd_pins homenc_coprocessor_5/rdM1] [get_bd_pins interfacer_5/rdM1]
  connect_bd_net -net interfacer_5_wtM0 [get_bd_pins homenc_coprocessor_5/wtM0] [get_bd_pins interfacer_5/wtM0]
  connect_bd_net -net interfacer_5_wtM1 [get_bd_pins homenc_coprocessor_5/wtM1] [get_bd_pins interfacer_5/wtM1]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_3/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_4/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_5/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_gpio_5/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/M03_ARESETN] [get_bd_pins axi_interconnect_1/M04_ARESETN] [get_bd_pins axi_interconnect_1/M05_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00020000 -offset 0xC8000000 [get_bd_addr_spaces f1_inst/M_AXI_PCIS] [get_bd_addr_segs axi_bram_ctrl_4/S_AXI/Mem0] SEG_axi_bram_ctrl_4_Mem0
  create_bd_addr_seg -range 0x00020000 -offset 0xCA000000 [get_bd_addr_spaces f1_inst/M_AXI_PCIS] [get_bd_addr_segs axi_bram_ctrl_5/S_AXI/Mem0] SEG_axi_bram_ctrl_5_Mem0
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00004000 [get_bd_addr_spaces f1_inst/M_AXI_OCL] [get_bd_addr_segs axi_gpio_4/S_AXI/Reg] SEG_axi_gpio_4_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00005000 [get_bd_addr_spaces f1_inst/M_AXI_OCL] [get_bd_addr_segs axi_gpio_5/S_AXI/Reg] SEG_axi_gpio_5_Reg
