...
long long int rlk50[NUM_PRIME][4096], rlk51[NUM_PRIME][4096];
...
////////////////  Relinearisation key reading /////////////////////////////
	...
	fp = fopen("sage_generated_key/rlk2_0", "r");
	for(i=0; i<4096; i++)
	gmp_fscanf(fp, "%Zd", big_array[i]);
	fclose(fp);
	for(i=0; i<NUM_PRIME; i++)
	...
	fp = fopen("sage_generated_key/rlk2_1", "r");
	for(i=0; i<4096; i++)
	gmp_fscanf(fp, "%Zd", big_array[i]);
	fclose(fp);
	for(i=0; i<NUM_PRIME; i++)
	...
	fp = fopen("sage_generated_key/rlk3_0", "r");
	for(i=0; i<4096; i++)
	gmp_fscanf(fp, "%Zd", big_array[i]);
	fclose(fp);
	for(i=0; i<NUM_PRIME; i++)
	...
	fp = fopen("sage_generated_key/rlk3_1", "r");
	for(i=0; i<4096; i++)
	gmp_fscanf(fp, "%Zd", big_array[i]);
	fclose(fp);
	for(i=0; i<NUM_PRIME; i++)
	...
	fp = fopen("sage_generated_key/rlk4_0", "r");
	for(i=0; i<4096; i++)
	gmp_fscanf(fp, "%Zd", big_array[i]);
	fclose(fp);
	for(i=0; i<NUM_PRIME; i++)
	...
	fp = fopen("sage_generated_key/rlk4_1", "r");
	for(i=0; i<4096; i++)
	gmp_fscanf(fp, "%Zd", big_array[i]);
	fclose(fp);
	for(i=0; i<NUM_PRIME; i++)
	...
	fp = fopen("sage_generated_key/rlk5_0", "r");
	for(i=0; i<4096; i++)
	gmp_fscanf(fp, "%Zd", big_array[i]);
	fclose(fp);
	for(i=0; i<NUM_PRIME; i++)
	{
		compute_mod(big_array, rlk50[i], i);
	}
	fp = fopen("sage_generated_key/rlk5_1", "r");
	for(i=0; i<4096; i++)
	gmp_fscanf(fp, "%Zd", big_array[i]);
	fclose(fp);
	for(i=0; i<NUM_PRIME; i++)
	{
		compute_mod(big_array, rlk51[i], i);
	}
...
{ 
	...
	long long int c2_shares[NUM_PRIME][4096], c2_shares_temp[4096];

	compute_shares(c2_full, c2_shares);
	...
	for(i=0; i<NUM_PRIME; i++)
	{
		poly_copy(c2_shares[0], c2_shares_temp);
		fwd_ntt_q(c2_shares_temp, i);
		coefficient_mul_q(rlk00[i], c2_shares_temp, rlk0_mul_cwd[i], i);
		coefficient_mul_q(rlk01[i], c2_shares_temp, rlk1_mul_cwd[i], i);

		poly_copy(c2_shares[1], c2_shares_temp);
		fwd_ntt_q(c2_shares_temp, i);
		coefficient_mul_q(rlk10[i], c2_shares_temp, temp[i], i);
		coefficient_add_q(rlk0_mul_cwd[i], temp[i], rlk0_mul_cwd[i], i);	// rlk0_mul_cwd[i] = rlk00[i]*cwd0_shares[i] + rlk10[i]*cwd1_shares[i]
		coefficient_mul_q(rlk11[i], c2_shares_temp, temp[i], i);
		coefficient_add_q(rlk1_mul_cwd[i], temp[i], rlk1_mul_cwd[i], i);	

		poly_copy(c2_shares[2], c2_shares_temp);		
		fwd_ntt_q(c2_shares_temp, i);
		coefficient_mul_q(rlk20[i], c2_shares_temp, temp[i], i);
		...
		coefficient_mul_q(rlk21[i], c2_shares_temp, temp[i], i);
		coefficient_add_q(rlk1_mul_cwd[i], temp[i], rlk1_mul_cwd[i], i);	

		poly_copy(c2_shares[3], c2_shares_temp);		
		fwd_ntt_q(c2_shares_temp, i);
		coefficient_mul_q(rlk30[i], c2_shares_temp, temp[i], i);
		coefficient_add_q(rlk0_mul_cwd[i], temp[i], rlk0_mul_cwd[i], i);	
		coefficient_mul_q(rlk31[i], c2_shares_temp, temp[i], i);
		coefficient_add_q(rlk1_mul_cwd[i], temp[i], rlk1_mul_cwd[i], i);	

		poly_copy(c2_shares[4], c2_shares_temp);		
		fwd_ntt_q(c2_shares_temp, i);
		coefficient_mul_q(rlk40[i], c2_shares_temp, temp[i], i);
		coefficient_add_q(rlk0_mul_cwd[i], temp[i], rlk0_mul_cwd[i], i);  	// rlk0_mul_cwd[i] = sum( rlk_j0[i]*cwd_j_shares[i])
		coefficient_mul_q(rlk41[i], c2_shares_temp, temp[i], i);
		coefficient_add_q(rlk1_mul_cwd[i], temp[i], rlk1_mul_cwd[i], i);	

		poly_copy(c2_shares[5], c2_shares_temp);		
		fwd_ntt_q(c2_shares_temp, i);
		coefficient_mul_q(rlk50[i], c2_shares_temp, temp[i], i);
		coefficient_add_q(rlk0_mul_cwd[i], temp[i], rlk0_mul_cwd[i], i);  	// rlk0_mul_cwd[i] = sum( rlk_j0[i]*cwd_j_shares[i])
		coefficient_mul_q(rlk51[i], c2_shares_temp, temp[i], i);
		coefficient_add_q(rlk1_mul_cwd[i], temp[i], rlk1_mul_cwd[i], i);	
	...
	// 	for(i=0; i<2048; i++)
	// 	{
	// 		a0 = c0_shares[j][i]; a1 = c0_shares[j][i+2048]; 
	// 		printf("%u %u\n", a1, a0);
	// 	}
	// }
